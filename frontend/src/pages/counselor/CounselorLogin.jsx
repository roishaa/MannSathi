            ...
            <div className="rounded-3xl border border-[#ebe4d7] bg-white/90 p-8 sm:p-10 shadow-[0_24px_70px_rgba(32,66,55,0.12)] backdrop-blur">
              ...
              <form onSubmit={handleSubmit} className="mt-6 space-y-5" noValidate>
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full inline-flex justify-center rounded-2xl border border-[#89ad8f] bg-gradient-to-b from-[#e8f5ea] to-[#d9eddc] px-5 py-3.5 text-sm font-semibold text-[#305b39] shadow-[0_8px_22px_rgba(101,143,108,0.24)] transition hover:-translate-y-[1px] hover:shadow-[0_10px_24px_rgba(101,143,108,0.3)] disabled:opacity-70 disabled:cursor-not-allowed"
                >
              ...
              <p className="mt-6 text-sm text-neutral-600 text-center">
                ...
                <Link to="/counselor/signup" className="text-[#305b39] font-semibold hover:underline">
