...
// ================= DEBUG ENDPOINTS =================
/**
 * Public endpoint: Test if Bearer token is being sent correctly
 * Usage: curl -H "Authorization: Bearer YOUR_TOKEN" http://127.0.0.1:8000/api/debug/bearer
 */
Route::get('/debug/bearer', function (Request $request) {
  ...
  // ✅ Token exists, get the tokenable model
...
/**
 * Protected endpoint: Test if multi.auth middleware works
 * Usage: curl -H "Authorization: Bearer YOUR_TOKEN" http://127.0.0.1:8000/api/debug/protected
 */
...
/**
 * Test endpoint: Verify complete auth flow
 */
